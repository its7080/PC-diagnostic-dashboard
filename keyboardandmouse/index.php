...
<div class="container">
    <div class="card">
        ...
        <div id="keyboard" class="keyboard-shell keyboard">
            <div class="row"><div class="key" data-code="Escape">Esc</div><div class="key" data-code="F1">F1</div><div class="key" data-code="F2">F2</div><div class="key" data-code="F3">F3</div><div class="key" data-code="F4">F4</div><div class="key" data-code="F5">F5</div><div class="key" data-code="F6">F6</div><div class="key" data-code="F7">F7</div><div class="key" data-code="F8">F8</div><div class="key" data-code="F9">F9</div><div class="key" data-code="F10">F10</div><div class="key" data-code="F11">F11</div><div class="key" data-code="F12">F12</div><div class="key" data-code="PrintScreen">PrtSc</div><div class="key" data-code="ScrollLock">ScrLk</div><div class="key" data-code="Pause">Pause</div><div class="key" data-code="MediaTrackPrevious">⏮</div><div class="key" data-code="MediaPlayPause">⏯</div><div class="key" data-code="MediaTrackNext">⏭</div><div class="key" data-code="VolumeMute">🔇</div><div class="key" data-code="VolumeDown">🔉</div><div class="key" data-code="VolumeUp">🔊</div></div>
            <div class="row"></div>
